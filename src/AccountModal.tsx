        ...
        {session ? (
          ...
          <>
            ...
            {SSO_ONLY ? (
              ...
              /* No SSO configured, which on this deployment is a
                 misconfiguration rather than a mode. GitHub, Google and the
                 magic link are gone: sign-in is through the company account or
                 not at all, and offering routes that were never going to be
                 enabled would be worse than saying so. */
              <p className="text-sm text-slate-400">
                Sign-in is not configured for this site yet. Nothing is lost —
                everything you have played is still here in this browser.
              </p>
            )}
          </>
        )}
